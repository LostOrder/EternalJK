...
XCVAR_DEF( cl_ratioFix,						"1",				UI_Set2DRatio,			CVAR_ARCHIVE ) //cvar name is shared in jaPRO cgame & LostJK engine
...
XCVAR_DEF( ui_selectedModelIndex,			"-1",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
